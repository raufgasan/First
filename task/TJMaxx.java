 ...
 * https://tjmaxx.com/
 */
public class TJMaxx extends OnSaleItem{
    ...
    public void removeItem(int catalogNumber) {
        regularItems.removeIf(i -> i.getCatalogNumber() == catalogNumber);
        onSaleItems.removeIf(j -> j.getCatalogNumber() == catalogNumber);
    ...
    public void buyItem(int catalogNumber) {
        regularItems.removeIf(i -> i.getCatalogNumber() == catalogNumber&&i.getQuantity()<2);
        onSaleItems.removeIf(j -> j.getCatalogNumber() == catalogNumber&&j.getQuantity()<2);
        regularItems.stream().filter(i->i.getCatalogNumber()==catalogNumber).forEach(i->i.setQuantity(i.getQuantity()-1));
        onSaleItems.stream().filter(i->i.getCatalogNumber()==catalogNumber).forEach(i->i.setQuantity(i.getQuantity()-1));
