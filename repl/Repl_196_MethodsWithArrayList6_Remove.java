...
public class Repl_196_MethodsWithArrayList6_Remove {
...
//        nums.remove(3);
//        nums.remove(3);
//        will result in (6,3,1,5), because after the first remove(3) is run, the 2 and 5 get pushed up into the 3rd and 4th index, and then the second remove(3)
//        will remove the 2, leaving the 5.  Ask Mr. Murodil to demonstrate this if you're still confused.
//
