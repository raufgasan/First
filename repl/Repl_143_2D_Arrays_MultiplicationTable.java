...
public class Repl_143_2D_Arrays_MultiplicationTable {

    public static void main(String[] args) {
//
//        Two-dimensional Arrays - 2D array has a type such as int[][] or String[][], with two pairs of square brackets. The elements of a
//        2D array are arranged in rows and columns, and the new operator for 2D arrays specifies both the number of rows and the number of columns.
//
