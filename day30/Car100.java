...
public class Car100 {
    public static void main(String[] args) {
        ...
        for (int x = 0; x < cars.length; x++) {
            ...
            String carSplit[] = cars[x].split("-");

//            "Chevrolet" "Colorado"
//

//            if (carSplit[0].equals("Honda")) {
//                System.out.println("Car make is " + carSplit[0] + " Car model is " + carSplit[1]);
//            }

            if (cars[x].length()==2&&carSplit [1].length() == 2) {
                count++;
                System.out.println(count + "-->" + x + "-->" + cars[x]);
            }
        }
