...
public class ArrayTAsk {
    ...
    int mcdonalsCount = 0;
        ...
        for (String mccount:restaurants ) {
            if (mccount.toLowerCase().contains("mcdonald's")){
                mcdonalsCount++;
            }
...
int countMC1 = 0;
        ...
        System.out.println("McDonald's Count without toLowerCase(): "+ countMC1);
        System.out.println("McDonald's Count toLowerCase(): "+ mcdonalsCount);
    ...
    int dominosCount = 0;
    int tacoBellCount = 0;
        for (String countres:restaurants      ) {
            if(countres.toLowerCase().contains("popeye's chicken")){
                popeyesCount++;
            }
            if(countres.toLowerCase().contains("domino's pizza")){
                dominosCount++;
            }
            if(countres.toLowerCase().contains("taco bell")){
                tacoBellCount++;
            }
        }
    ...
    //TASK 5. Find all McDonald's in TX and print out info with number:
         ...
         */
        int countMc=0;
        for (String maccount:restaurants  ) {

            if (maccount.toLowerCase().contains("mcdonald's")&&maccount.contains("TX")){
                countMc++;
            }

        }

        System.out.println("McDonald's Count in TX: "+countMc);
    ...
    //McDonald's -> Massena, NY
        ...
        String arrTostring = restaurants[0];
        System.out.println("First rest: " + arrTostring);
        System.out.println("First rest: "+ Arrays.toString(firstRest));
        System.out.println(firstRest[2]+" -> "+firstRest[1]+", "+firstRest[4]);
    ...
    //TASK 7. Print each restaurant name, City, state in above format for all restaurants
        ...
        for (int x = 0; x <restaurants.length ; x++) {
           ...
           String restaurants1[]=restaurants[x].split(",");
                            System.out.println(restaurants1[2]+" -> "+restaurants1[1]+", "+restaurants1[4]);
